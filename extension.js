...
export default class TrayNestExtension extends Extension.Extension {
    constructor(...args) {
        super(...args);
    ...
    enable() {
        ...
        QuickSettingsManager.QuickSettingsManager.initialize();
    }

    disable() {
        this._isEnabled = false;
        TrayIconsManager.TrayIconsManager.destroy();
        IndicatorGroupManager.IndicatorGroupManager.destroy();
        QuickSettingsManager.QuickSettingsManager.destroy();
